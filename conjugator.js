...
function validateParams(verb, stem, suffix){
	...
	//below is a list of some common irregular verbs that we'll check for
	var commonIrregulars = ["ser", "estar", "tener", "hacer", "poder", "decir", "ir", "ver", "dar", "saber", "querer", "llegar", "poner", "parecer", "quedar", "creer", "dejar", "seguir", "encontrar", "llamar", "venir", "pensar", "salir", "volver", "conocer", "sentir", "contar", "empezar", "entrar"];
	
	for(var i = 0; i < commonIrregulars.length; i++){
		if(verb == commonIrregulars[i]){
			$("#conjform").before("<div class='feedback'>That is an irregular verb. You must enter a regular infinitive verb.<div>");
			return false;
		}
	}
	
	//if we get here, the form of the verb is ok
	return true;
